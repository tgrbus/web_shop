...
/****** Object:  Database [web_shop]    Script Date: 9.11.2025. 19:04:44 ******/
CREATE DATABASE [web_shop]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'web_shop', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\web_shop.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'web_shop_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\web_shop_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [web_shop] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [web_shop] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [web_shop] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [web_shop] SET QUERY_STORE = ON
GO

ALTER DATABASE [web_shop] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
